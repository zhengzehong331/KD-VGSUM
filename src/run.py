...
if __name__ == '__main__':
    ...
    parser.add_argument('-model', default='text_only_bart', type=str,
                        help='We have for models to choose, text_only_bart, multi_modal_bart,  text_only_t5 and multi_modal_t5')
    parser.add_argument('-checkpoint', default='./lightning_logs/version_7/checkpoints/epoch=29-step=4499.ckpt',
                        type=str, help='The checkpoint path')
    parser.add_argument('-train_src_path', default='./dataset/sum_train/tran.tok.txt',
                        type=str, help='training input data path (dialogue)')
    parser.add_argument('-train_tgt_path', default='./dataset/sum_train/desc.tok.txt',
                        type=str, help='training output data path (summary)')
    parser.add_argument('-val_src_path', default='./dataset/sum_cv/tran.tok.txt',
                        type=str, help='validatioin input data path (dialogue)')
    parser.add_argument('-val_tgt_path', default='./dataset/sum_cv/desc.tok.txt',
                        type=str, help='validatioin output data path (summary)')
    parser.add_argument('-test_src_path', default='./dataset/sum_devtest/tran.tok.txt',
                        type=str, help='testing input data path (dialogue)')
    parser.add_argument('-test_tgt_path', default='./dataset/sum_devtest/desc.tok.txt',
                        type=str, help='testing output data path (summary)')
    parser.add_argument('-image_feature_path', default='./dataset/video_action_features/',
                        type=str, help='video features path')
    parser.add_argument('-val_save_file', default='./evaluation/temp_valid_file',
                        type=str, help='the validation results for each epoch')
    parser.add_argument('-test_save_file', default='./evaluation/results/test_summaries.txt',
                        type=str, help='the generated summary for testing data')
    parser.add_argument('-log_name', default='multi_modal_bart',
                        type=str, help='lightning log path')
    parser.add_argument('-gpus', default='0,2,3,4', type=str,
                        help='choose gpus to run the code, you can choose multipple gpus')
    parser.add_argument('-batch_size', type=int, default=4,
                        help='batch size for each gpu')
    parser.add_argument('-max_input_len', type=int, default=512,
                        help='the maximun length for input dialogue')
    parser.add_argument('-max_output_len', type=int, default=64,
                        help='the maximun length for output summary')
    parser.add_argument('-max_img_len', type=int, default=256,
                        help='the maximun length for video features')
    parser.add_argument('-n_beams', type=int, default=4,
                        help='the number of beams using for generation')
    parser.add_argument('-no_repeat_ngram_size', type=int, default=3,
                        help='the size of no repeat ngrams during generation')
    parser.add_argument('-learning_rate', default=3e-5,
                        type=float, help='learning rate')
    parser.add_argument('-scheduler_lambda1', default=20,
                        type=int, help='change the learning each lambda1 epoch')
    parser.add_argument('-scheduler_lambda2', default=0.95, type=float,
                        help='the learning rate will times lambda2 for each change')
    parser.add_argument('-num_epochs', type=int, default=100,
                        help='maximun number of training epoches')
    parser.add_argument('-grad_accumulate', type=int, default=10,
                        help='gradient accumulation for this number iterations')
    parser.add_argument('-random_seed', type=int,
                        default=0, help='global random seed')
    parser.add_argument('-do_train', type=str, default='True',
                        help='set True to training, set False to not training')
    parser.add_argument('-do_test', type=str, default='True',
                        help='set True to testing, set False to not testing')
    parser.add_argument('-limit_val_batches', default=1.0,
                        type=float, help='do validation for each epoch')
    ...
    parser.add_argument('-use_forget_gate', action='store_true',
    ...
    # only needed when cross_attn_type is 4 or 5
